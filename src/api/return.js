...
export function listOfReturnMaterials(deptID, organizationID, userId, userName, documentStatus, beginDate, endDate, billNo, billTypeID, pageIndex, pageSize) {
  const data = [{
    'deptID': deptID,
    'OrganizationID': organizationID,
    UserId: userId,
